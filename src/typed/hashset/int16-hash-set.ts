...
export class Int16HashSet {
  ...
  static bulkLoadExact(
    ...
    const set = new Int16HashSet(hashCapacityFor(n));
   ...
   */
  static bulkLoad(values: Iterable<number>, opts?: BulkLoadOptions): Int16HashSet {
    const onDuplicate = opts?.onDuplicate ?? "error";
    ...
    const set =
      hint !== undefined ? new Int16HashSet(hashCapacityFor(hint)) : new Int16HashSet();
    let i = 0;
    for (const value of values) {
