...
export class BigInt64HashSet {
  ...
  static bulkLoadExact(
    ...
    const set = new BigInt64HashSet(hashCapacityFor(n));
   ...
   */
  static bulkLoad(values: Iterable<bigint>, opts?: BulkLoadOptions): BigInt64HashSet {
    ...
    return BigInt64HashSet.bulkLoadExact(buffer, buffer.length, opts);
  }
