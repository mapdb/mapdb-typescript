...
import { ImmutableInt8HashSet } from "./immutable_int8-hash-set.js";
...
describe("ImmutableInt8HashSet generated", () => {
  ...
  it("contains and includes", () => {
    const set = ImmutableInt8HashSet.of([1, 2]);
    expect(set.contains(1)).toBe(true);
  ...
  it("filter", () => {
    const set = ImmutableInt8HashSet.of([1, 2, 3, 4]);
  ...
  it("memoryBytes", () => {
    ...
    expect(set.memoryBytes()).toBeGreaterThanOrEqual(3 * (1 + 1));
  });

  it("defensive copy - modifying source array doesn't affect immutable", () => {
    const source = [1, 2, 3];
    const set = ImmutableInt8HashSet.of(source);
    source[0] = 99 as any;
    expect(set.contains(1)).toBe(true);
    expect(set.contains(99)).toBe(false);
  });
  ...
  it("has no add method", () => {
    const set = ImmutableInt8HashSet.of([1]);
