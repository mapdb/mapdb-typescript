...
/**
 * Int8→Float64 hash map backed by Int8Array and Float64Array.
 ...
 */
export class Int8Float64HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int8Float64HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    return Int8Float64HashMap.bulkLoadExact(buffer, buffer.length, opts);
  }
