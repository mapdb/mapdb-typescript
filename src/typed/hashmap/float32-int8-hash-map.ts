...
/**
 * Float32→Int8 hash map backed by Float32Array and Int8Array.
 ...
 */
export class Float32Int8HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float32Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float32Int8HashMap(hashCapacityFor(hint)) : new Float32Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
