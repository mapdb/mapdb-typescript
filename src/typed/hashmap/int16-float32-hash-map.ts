...
/**
 * Int16→Float32 hash map backed by Int16Array and Float32Array.
 ...
 */
export class Int16Float32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int16Float32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int16Float32HashMap(hashCapacityFor(hint)) : new Int16Float32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
