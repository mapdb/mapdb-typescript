...
/**
 * Int8→BigInt64 hash map backed by Int8Array and BigInt64Array.
 ...
 */
export class Int8BigInt64HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int8BigInt64HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int8BigInt64HashMap(hashCapacityFor(hint)) : new Int8BigInt64HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
