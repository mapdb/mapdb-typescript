...
/**
 * Int8→Float32 hash map backed by Int8Array and Float32Array.
 ...
 */
export class Int8Float32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int8Float32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int8Float32HashMap(hashCapacityFor(hint)) : new Int8Float32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
