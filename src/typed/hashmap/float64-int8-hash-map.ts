...
/**
 * Float64→Int8 hash map backed by Float64Array and Int8Array.
 ...
 */
export class Float64Int8HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float64Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float64Int8HashMap(hashCapacityFor(hint)) : new Float64Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
