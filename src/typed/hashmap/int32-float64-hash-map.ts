...
/**
 * Int32→Float64 hash map backed by Int32Array and Float64Array.
 ...
 */
export class Int32Float64HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int32Float64HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int32Float64HashMap(hashCapacityFor(hint)) : new Int32Float64HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
