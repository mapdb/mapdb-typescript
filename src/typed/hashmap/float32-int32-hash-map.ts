...
/**
 * Float32→Int32 hash map backed by Float32Array and Int32Array.
 ...
 */
export class Float32Int32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float32Int32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float32Int32HashMap(hashCapacityFor(hint)) : new Float32Int32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
