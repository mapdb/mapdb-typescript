...
/**
 * Int32→Int16 hash map backed by Int32Array and Int16Array.
 ...
 */
export class Int32Int16HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int32Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int32Int16HashMap(hashCapacityFor(hint)) : new Int32Int16HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
