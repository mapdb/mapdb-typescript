...
/**
 * Int16→BigInt64 hash map backed by Int16Array and BigInt64Array.
 ...
 */
export class Int16BigInt64HashMap {
  ...
  ): Int16BigInt64HashMap {
    checkExpectedSize(n);
    const onDuplicate = opts?.onDuplicate ?? "error";
    const map = new Int16BigInt64HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    return Int16BigInt64HashMap.bulkLoadExact(buffer, buffer.length, opts);
  }
