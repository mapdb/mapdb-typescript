...
/**
 * Int16→Float64 hash map backed by Int16Array and Float64Array.
 ...
 */
export class Int16Float64HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int16Float64HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int16Float64HashMap(hashCapacityFor(hint)) : new Int16Float64HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
