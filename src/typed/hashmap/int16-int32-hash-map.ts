...
/**
 * Int16→Int32 hash map backed by Int16Array and Int32Array.
 ...
 */
export class Int16Int32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int16Int32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int16Int32HashMap(hashCapacityFor(hint)) : new Int16Int32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
