...
/**
 * BigInt64→Int16 hash map backed by BigInt64Array and Int16Array.
 ...
 */
export class BigInt64Int16HashMap {
  ...
  ): BigInt64Int16HashMap {
    checkExpectedSize(n);
    const onDuplicate = opts?.onDuplicate ?? "error";
    const map = new BigInt64Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    return BigInt64Int16HashMap.bulkLoadExact(buffer, buffer.length, opts);
  }
