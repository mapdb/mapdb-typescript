...
/**
 * BigInt64→Int8 hash map backed by BigInt64Array and Int8Array.
 ...
 */
export class BigInt64Int8HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new BigInt64Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new BigInt64Int8HashMap(hashCapacityFor(hint)) : new BigInt64Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
