...
/**
 * Int8→Int8 hash map backed by Int8Array and Int8Array.
...
export class Int8Int8HashMap {
  ...
  constructor(capacity = DEFAULT_CAPACITY) {
    ...
    this.values = new Int8Array(this.capacity);
  ...
  static bulkLoadExact(
    ...
    const map = new Int8Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int8Int8HashMap(hashCapacityFor(hint)) : new Int8Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
