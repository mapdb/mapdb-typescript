...
/**
 * Int16→Int16 hash map backed by Int16Array and Int16Array.
 ...
 */
export class Int16Int16HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int16Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int16Int16HashMap(hashCapacityFor(hint)) : new Int16Int16HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
