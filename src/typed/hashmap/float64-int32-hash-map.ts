...
/**
 * Float64→Int32 hash map backed by Float64Array and Int32Array.
 ...
 */
export class Float64Int32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float64Int32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float64Int32HashMap(hashCapacityFor(hint)) : new Float64Int32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
