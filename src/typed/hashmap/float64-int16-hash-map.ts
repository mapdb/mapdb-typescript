...
/**
 * Float64→Int16 hash map backed by Float64Array and Int16Array.
 ...
 */
export class Float64Int16HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float64Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float64Int16HashMap(hashCapacityFor(hint)) : new Float64Int16HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
