...
/**
 * Int32→Int8 hash map backed by Int32Array and Int8Array.
...
export class Int32Int8HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int32Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int32Int8HashMap(hashCapacityFor(hint)) : new Int32Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
