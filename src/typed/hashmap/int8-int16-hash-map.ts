...
/**
 * Int8→Int16 hash map backed by Int8Array and Int16Array.
...
export class Int8Int16HashMap {
  ...
  constructor(capacity = DEFAULT_CAPACITY) {
    ...
    this.keys = new Int8Array(this.capacity);
    this.values = new Int16Array(this.capacity);
  ...
  static bulkLoadExact(
    ...
    const map = new Int8Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int8Int16HashMap(hashCapacityFor(hint)) : new Int8Int16HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
