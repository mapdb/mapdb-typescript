...
/**
 * Int32→Float32 hash map backed by Int32Array and Float32Array.
 ...
 */
export class Int32Float32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int32Float32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int32Float32HashMap(hashCapacityFor(hint)) : new Int32Float32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
