...
/**
 * Int8→Int32 hash map backed by Int8Array and Int32Array.
...
export class Int8Int32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int8Int32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int8Int32HashMap(hashCapacityFor(hint)) : new Int8Int32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
