...
/**
 * Int32→Int32 hash map backed by Int32Array and Int32Array.
 ...
 */
export class Int32Int32HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Int32Int32HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int32Int32HashMap(hashCapacityFor(hint)) : new Int32Int32HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
