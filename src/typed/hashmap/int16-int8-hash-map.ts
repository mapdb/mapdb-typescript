...
/**
 * Int16→Int8 hash map backed by Int16Array and Int8Array.
...
export class Int16Int8HashMap {
  ...
  constructor(capacity = DEFAULT_CAPACITY) {
    ...
    this.keys = new Int16Array(this.capacity);
  ...
  static bulkLoadExact(
    ...
    const map = new Int16Int8HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Int16Int8HashMap(hashCapacityFor(hint)) : new Int16Int8HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
