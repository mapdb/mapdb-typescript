...
/**
 * Float32→Int16 hash map backed by Float32Array and Int16Array.
 ...
 */
export class Float32Int16HashMap {
  ...
  static bulkLoadExact(
    ...
    const map = new Float32Int16HashMap(hashCapacityFor(n));
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float32Int16HashMap(hashCapacityFor(hint)) : new Float32Int16HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
