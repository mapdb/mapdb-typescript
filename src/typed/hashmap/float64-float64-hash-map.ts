...
/**
 * Float64→Float64 hash map backed by Float64Array and Float64Array.
 ...
 */
export class Float64Float64HashMap {
  ...
  static bulkLoad(
    ...
    const map =
      hint !== undefined ? new Float64Float64HashMap(hashCapacityFor(hint)) : new Float64Float64HashMap();
    let i = 0;
    for (const [key, value] of pairs) {
