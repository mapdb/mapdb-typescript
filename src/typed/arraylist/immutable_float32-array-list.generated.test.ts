...
describe("ImmutableFloat32ArrayList generated", () => {
  ...
  it("fromMutable creates defensive copy", () => {
    const mutable = new Float32ArrayList();
    mutable.add(1);
    mutable.add(2);
  ...
  it("get with bounds check", () => {
    const list = ImmutableFloat32ArrayList.of([1, 2]);
    expect(list.get(0)).toBe(1);
  ...
  it("filter", () => {
    const list = ImmutableFloat32ArrayList.of([1, 2, 3, 4]);
  ...
  it("defensive copy - modifying source array doesn't affect immutable", () => {
    const source = [1, 2, 3];
    const list = ImmutableFloat32ArrayList.of(source);
    source[0] = 99 as any;
    expect(list.get(0)).toBe(1);
  });
  ...
  it("has no add method", () => {
    const list = ImmutableFloat32ArrayList.of([1]);
