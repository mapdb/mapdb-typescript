...
import { ImmutableInt16ArrayList } from "./immutable_int16-array-list.js";
...
describe("ImmutableInt16ArrayList generated", () => {
  ...
  it("fromMutable creates defensive copy", () => {
    const mutable = new Int16ArrayList();
    mutable.add(1);
    mutable.add(2);
  ...
  it("get with bounds check", () => {
    const list = ImmutableInt16ArrayList.of([1, 2]);
    expect(list.get(0)).toBe(1);
  ...
  it("filter", () => {
    const list = ImmutableInt16ArrayList.of([1, 2, 3, 4]);
  ...
  it("memoryBytes", () => {
    const list = ImmutableInt16ArrayList.of([1, 2, 3]);
    // 3 elements * byteSize
    expect(list.memoryBytes()).toBe(3 * 2);
  });

  it("defensive copy - modifying source array doesn't affect immutable", () => {
    const source = [1, 2, 3];
    const list = ImmutableInt16ArrayList.of(source);
    source[0] = 99 as any;
    expect(list.get(0)).toBe(1);
  });
  ...
  it("has no add method", () => {
    const list = ImmutableInt16ArrayList.of([1]);
