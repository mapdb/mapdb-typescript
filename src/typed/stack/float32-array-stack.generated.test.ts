...
describe("Float32ArrayStack generated", () => {
  it("push and pop", () => {
  ...
  it("memoryBytes", () => {
    const s = new Float32ArrayStack(64);
    expect(s.memoryBytes()).toBe(64 * 4);
  });
  ...
  it("of factory", () => {
    const s = Float32ArrayStack.of([1, 2, 3]); // last element is top
    expect(s.size()).toBe(3);
