...
import { ImmutableFloat32ArrayStack } from "./immutable_float32-array-stack.js";
import { Float32ArrayStack } from "./float32-array-stack.js";
...
describe("ImmutableFloat32ArrayStack generated", () => {
  ...
  it("fromMutable creates defensive copy", () => {
    const mutable = new Float32ArrayStack();
    mutable.push(1);
    mutable.push(2);
  ...
  it("peek returns top element", () => {
    const stack = ImmutableFloat32ArrayStack.of([1, 2, 3]); // top = 3
    expect(stack.peek()).toBe(3);
  });

  it("peek throws on empty", () => {
    const stack = ImmutableFloat32ArrayStack.of([]);
  ...
  it("peekAt throws on out of bounds", () => {
    const stack = ImmutableFloat32ArrayStack.of([1]);
  ...
  it("contains and includes", () => {
    const stack = ImmutableFloat32ArrayStack.of([1, 2]);
  ...
  it("every / some", () => {
    const stack = ImmutableFloat32ArrayStack.of([1, 2, 3]);
  ...
  it("filter top to bottom", () => {
    const stack = ImmutableFloat32ArrayStack.of([1, 2, 3, 4]);
  ...
  it("toString", () => {
    const stack = ImmutableFloat32ArrayStack.of([1, 2]); // top = 2
  ...
  it("defensive copy - modifying source array doesn't affect immutable", () => {
    const source = [1, 2, 3];
    const stack = ImmutableFloat32ArrayStack.of(source);
    source[0] = 99 as any;
    expect(stack.peek()).toBe(3);
  });
