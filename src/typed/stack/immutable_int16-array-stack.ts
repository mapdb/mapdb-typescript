...
/**
 * Immutable stack (LIFO) backed by Int16Array.
...
export class ImmutableInt16ArrayStack {
  ...
  *[Symbol.iterator](): IterableIterator<number> {
  ...
  toMutable(): Int16ArrayStack {
    return Int16ArrayStack.fromImmutable(this);
  }
