...
describe("Int16ArrayStack generated", () => {
  it("push and pop", () => {
    const s = new Int16ArrayStack();
    s.push(1);
    s.push(2);
    s.push(3);
  ...
  it("memoryBytes", () => {
    const s = new Int16ArrayStack(64);
    expect(s.memoryBytes()).toBe(64 * 2);
  });
  ...
  it("of factory", () => {
    const s = Int16ArrayStack.of([1, 2, 3]); // last element is top
    expect(s.size).toBe(3);
