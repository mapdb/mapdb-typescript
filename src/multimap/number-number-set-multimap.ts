...
export class NumberNumberSetMultimap {
  ...
  static fromSorted(
    ...
    const mm = new NumberNumberSetMultimap();
  ...
  static fromSortedKeys(
    ...
    return NumberNumberSetMultimap.fromSorted(sortedPairs);
  }
...
/**
 * Streaming builder for a {@link NumberNumberSetMultimap} (the data pump's Sink form). Buffer
 ...
 */
export class NumberNumberSetMultimapSink {
  private mm: NumberNumberSetMultimap = new NumberNumberSetMultimap();
  ...
  create(): NumberNumberSetMultimap {
    if (this.poisoned) throw new Error("sink is poisoned after a prior error");
    if (this.done) throw new Error("sink already created");
    this.done = true;
    return this.mm;
