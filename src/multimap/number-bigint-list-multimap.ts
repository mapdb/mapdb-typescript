...
export class NumberBigIntListMultimap {
  ...
  static fromSorted(
    ...
    const mm = new NumberBigIntListMultimap();
  ...
  static fromSortedKeys(
    ...
    return NumberBigIntListMultimap.fromSorted(sortedPairs);
  }
...
/**
 * Streaming builder for a {@link NumberBigIntListMultimap} (the data pump's Sink form). Buffer
 ...
 */
export class NumberBigIntListMultimapSink {
  private mm: NumberBigIntListMultimap = new NumberBigIntListMultimap();
  ...
  create(): NumberBigIntListMultimap {
    if (this.poisoned) throw new Error("sink is poisoned after a prior error");
    if (this.done) throw new Error("sink already created");
    this.done = true;
    return this.mm;
