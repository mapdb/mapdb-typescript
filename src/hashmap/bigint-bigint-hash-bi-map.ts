 ...
 */
export class BigIntBigIntHashBiMap {
  private _forward: Map<bigint, bigint>;
  private _inverse: Map<bigint, bigint>;

  constructor() {
    this._forward = new Map<bigint, bigint>();
    this._inverse = new Map<bigint, bigint>();
  }
  ...
  getKey(value: bigint): bigint | undefined {
   ...
   */
  removeKey(key: bigint): bigint | undefined {
   ...
   */
  removeValue(value: bigint): bigint | undefined {
  ...
  equals(other: BigIntBigIntHashBiMap): boolean {
