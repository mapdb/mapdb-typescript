...
export class NumberBigIntHashBiMap {
  ...
  static of(): NumberBigIntHashBiMap {
    return new NumberBigIntHashBiMap();
  }
   ...
   */
  static bulkLoad(pairs: Iterable<readonly [number, bigint]>): NumberBigIntHashBiMap {
  ...
  getKey(value: bigint): number | undefined {
   ...
   */
  removeValue(value: bigint): number | undefined {
  ...
  equals(other: NumberBigIntHashBiMap): boolean {
